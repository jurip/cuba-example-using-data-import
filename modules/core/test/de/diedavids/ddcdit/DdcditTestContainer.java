...
public class DdcditTestContainer extends TestContainer {

    public DdcditTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/cuba/dataimport/app.properties",
                "de/diedavids/ddcdit/app.properties",
    ...
    public static class Common extends DdcditTestContainer {

        public static final DdcditTestContainer.Common INSTANCE = new DdcditTestContainer.Common();
